...
class General extends Component
{
    ...
    public function render()
    {
        ...
        $cleanings = AircraftCleaning::where('type', 'General')
        ...
        return view('livewire.modules.aircraft-cleaning.general', [
            'cleanings' => $cleanings,
        ])->layout('components.layouts.app', ['title' => 'General Cleaning']);
    }
    ...
    public function save()
    {
        ...
        $this->dispatch('notify', ['icon' => 'success', 'message' => 'Data General Cleaning berhasil disimpan!']);
        auth()->user()->notify(new SystemNotification(['type' => 'success', 'title' => 'Sistem', 'message' => 'Data General Cleaning berhasil disimpan!']));
        $this->closeModal();
    }
