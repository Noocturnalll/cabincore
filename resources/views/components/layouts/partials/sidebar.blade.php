    <aside id="cbm-sidebar" class="cbm-sidebar">
        ...
        <nav class="cbm-sidebar-nav">
            ...
            <div class="cbm-nav-section-label">Findings</div>
            <a href="{{ route('modules.ict') }}" wire:navigate class="cbm-nav-item {{ request()->routeIs('modules.ict') ? 'cbm-active' : '' }}">
            ...
            <a href="{{ route('aircraft.history') }}" wire:navigate class="cbm-nav-item {{ request()->routeIs('aircraft.history') ? 'cbm-active' : '' }}">
