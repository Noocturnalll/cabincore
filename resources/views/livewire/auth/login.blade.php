...
<style>
/* ============================================================
   CABIN CORE LOGIN — Calm, Clean, Colorful
   All selectors scoped under .cl to avoid Tailwind conflicts
============================================================ */
...
/* --- Left --- */
.cl-left {
    display: none; flex-direction: column; width: 50%; position: relative; overflow: hidden;
    background-color: #0f1d3d; background-size: cover; background-position: center;
}
.cl-left::before {
    content: ''; position: absolute; inset: 0; z-index: 0;
    background: linear-gradient(160deg, rgba(8,11,25,.92), rgba(30,64,175,.55) 50%, rgba(8,11,25,.95));
}
@media(min-width:992px) { .cl-left { display: flex; } }
.cl-left-in { display: flex; flex-direction: column; justify-content: space-between; height: 100%; padding: 2rem; position: relative; z-index: 1; overflow-y: auto; overflow-x: hidden; }
...
/* Stats */
.cl-stats { display: flex; align-items: center; gap: 1.25rem; }
.cl-sn { font-size: 1.25rem; font-weight: 800; color: #fff; }
.cl-sl { font-size: .5625rem; color: rgba(255,255,255,.45); margin-top: .15rem; font-weight: 700; text-transform: uppercase; letter-spacing: .06em; }
.cl-sd { width: 1px; height: 2rem; background: rgba(255,255,255,.15); }
...
.cl-lbl-row { display: flex; align-items: center; justify-content: space-between; }
.cl-forgot { font-size: .75rem; font-weight: 600; color: var(--blue); text-decoration: none; transition: color .15s; }
.cl-forgot:hover { color: #93c5fd; }
...
.cl-iw.f { border-color: var(--blue) !important; background: rgba(59,130,246,.07) !important; box-shadow: 0 0 0 3px rgba(59,130,246,.15) !important; }
...
.cl-note {
    ...
    border-radius: .625rem; color: rgba(148,163,184,.75);
}
...
/* --- LIGHT MODE --- */
.cl.lt {
    --bg: #f0f4f8; --panel: #f7f9fc;
    --card-bg: #ffffff; --card-border: rgba(100,116,139,.2);
    --txt: #1e293b; --muted: #475569;
    --input-bg: #f8fafc; --input-bd: #cbd5e1;
...
.cl.lt .cl-inp { color: #1e293b; }
.cl.lt .cl-inp::placeholder { color: #94a3b8; }
.cl.lt .cl-eye { color: #94a3b8; }
.cl.lt .cl-eye:hover { color: #475569; background: rgba(0,0,0,.04); }
.cl.lt .cl-forgot { color: #1d4ed8; }
.cl.lt .cl-forgot:hover { color: #1e40af; }
.cl.lt .cl-note { background: #eff6ff; border-color: rgba(29,78,216,.15); color: #1e40af; }
.cl.lt .cl-pw { color: #64748b; }
.cl.lt .cl-pw strong { color: #475569; }
...
<div class="cl" id="clRoot">
    ...
    <div class="cl-wrap">
        ...
        {{-- ===== LEFT ===== --}}
        <div class="cl-left" style="background-image: url('{{ asset('images/cabin-bg.jpg') }}');">
            <div class="cl-left-in">
                ...
                <div class="cl-hero">
                    ...
                    <div class="cl-stats">
                        ...
                        <div class="cl-sd"></div>
                        <div><div class="cl-sn">18+</div><div class="cl-sl">Airports</div></div>
                        <div class="cl-sd"></div>
                        <div><div class="cl-sn">7</div><div class="cl-sl">Modules</div></div>
                    </div>
                </div>
        ...
        <div class="cl-right">
            ...
            <div class="cl-mob">
                ...
                <div class="cl-mob-sub">Batam Aero Technic</div>
            </div>
            ...
            <div class="cl-card">
                ...
                <div class="cl-hdr">
                    <div class="cl-hdr-icon">
                        <svg style="width:1.125rem;height:1.125rem;display:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M18.685 19.097A9.723 9.723 0 0021.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 003.065 7.097A9.716 9.716 0 0012 21.75a9.716 9.716 0 006.685-2.653zm-12.54-1.285A7.486 7.486 0 0112 15a7.486 7.486 0 015.855 2.812A8.224 8.224 0 0112 20.25a8.224 8.224 0 01-5.855-2.438zM15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" clip-rule="evenodd"/></svg>
                    </div>
                    <div>
                        <div class="cl-hdr-t">Selamat Datang</div>
                        <div class="cl-hdr-s">Masuk ke akun karyawan Anda</div>
                    </div>
                </div>
                ...
                <form wire:submit="login" class="cl-form" novalidate>
                    ...
                    <div class="cl-fld">
                        ...
                        <div class="cl-iw" id="clNik">
                            <div class="cl-iw-ic">
                                <svg style="width:1rem;height:1rem;display:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd"/></svg>
                            </div>
                            <input wire:model="nik" type="text" id="nik" class="cl-inp"
                                placeholder="Masukkan ID karyawan Anda" autocomplete="username"
                    ...
                    <div class="cl-fld">
                        ...
                        <div class="cl-iw" id="clPw">
                            ...
                            <button type="button" class="cl-eye" aria-label="Toggle password"
                                onclick="var i=document.getElementById('password'),a=document.getElementById('clEyeS'),b=document.getElementById('clEyeH');if(i.type==='password'){i.type='text';a.style.display='none';b.style.display='block'}else{i.type='password';a.style.display='block';b.style.display='none'}">
                                <svg id="clEyeS" style="width:1rem;height:1rem;display:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 15a3 3 0 100-6 3 3 0 000 6z"/><path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 010-1.113zM17.25 12a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" clip-rule="evenodd"/></svg>
                                <svg id="clEyeH" style="width:1rem;height:1rem;display:none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3.53 2.47a.75.75 0 00-1.06 1.06l18 18a.75.75 0 101.06-1.06l-18-18zM22.676 12.553a11.249 11.249 0 01-2.631 4.31l-3.099-3.099a5.25 5.25 0 00-6.71-6.71L7.759 4.577a11.217 11.217 0 014.242-.827c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113z"/><path d="M15.75 12c0 .18-.013.357-.037.53l-4.244-4.243A3.75 3.75 0 0115.75 12zM12.22 15.713l-4.243-4.244a3.75 3.75 0 004.243 4.243z"/></svg>
                            </button>
                        </div>
                        @error('password')
                        <div class="cl-err">
                    ...
                    {{-- Submit --}}
                    <button type="submit" class="cl-btn" id="clSubmit">
                        <span wire:loading.remove wire:target="login" style="display:flex;align-items:center;gap:.4375rem">
                        ...
                        <span wire:loading wire:target="login" style="display:none;align-items:center;gap:.4375rem">
                ...
                <div class="cl-note">
                    <svg style="width:.875rem;height:.875rem;flex-shrink:0;display:block;color:#60a5fa;margin-top:.0625rem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z" clip-rule="evenodd"/></svg>
                    <p>Login pertama kali? Anda akan diminta mengganti password default sebelum mengakses sistem.</p>
                </div>
            </div>
