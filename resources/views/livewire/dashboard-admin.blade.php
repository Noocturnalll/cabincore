<div>
<style>
/* ═══ Dashboard &mdash; Enterprise Colorful Edition ═══ */
    ...
    <div style="overflow-x:auto;">
        <table style="width:100%;text-align:left;border-collapse:collapse;font-size:.875rem;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--cbm-divider); font-size: 0.875rem; color: var(--cbm-text);" onmouseover="this.style.background='var(--cbm-nav-hover)'" onmouseout="this.style.background=''">
                ...
                @empty
                <tr style="border-bottom: 1px solid var(--cbm-divider); font-size: 0.875rem; color: var(--cbm-text);">
