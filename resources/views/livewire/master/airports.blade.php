<div>
    <div class="cbm-page-header">
        <div style="display: flex; align-items: center; gap: 1rem;">
            ...
            <div>
                <h1 class="cbm-greeting" style="font-size: 1.5rem;">Master Bandara / Stasiun</h1>
                <p class="cbm-greeting-sub">Kelola data stasiun operasional</p>
            </div>
        </div>
    </div>
    ...
    <div class="cbm-card" style="text-align: center; padding: 4rem 2rem;">
        ...
        <p style="color: var(--cbm-text-sub); font-size: 0.875rem; max-width: 400px; margin: 0 auto;">Antarmuka dan fungsionalitas untuk modul <strong>Master Bandara / Stasiun</strong> sedang dalam tahap pengembangan sesuai dengan desain sistem role-based.</p>
    </div>
</div>
