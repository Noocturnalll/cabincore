<div>
    <div class="cbm-page-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; margin-bottom: 2rem;">
        <div style="display: flex; align-items: center; gap: 1.25rem;">
            <div style="width: 3.5rem; height: 3.5rem; border-radius: 1rem; background: linear-gradient(135deg, #14b8a6, #0d9488); display: flex; align-items: center; justify-content: center; color: white; flex-shrink: 0; box-shadow: 0 8px 16px rgba(20,184,166,0.3);">
            ...
            <div>
                <h1 class="cbm-greeting" style="font-size: 1.75rem; font-weight: 800; margin: 0; letter-spacing: -0.025em;">General Cleaning</h1>
                <p class="cbm-greeting-sub" style="font-size: 0.875rem; opacity: 0.8; margin-top: 0.25rem;">Log dan laporan pencucian umum pesawat</p>
            </div>
        </div>
    </div>
    ...
    <div class="cbm-card">
        <div class="cbm-card-header" style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--cbm-card-border); padding-bottom: 1.25rem; margin-bottom: 0;">
            <div style="position: relative; width: 300px;">
                ...
                <input type="text" placeholder="Cari General Cleaning..." class="cbm-input" style="padding-left: 2.75rem; width: 100%; height: 2.75rem; border-radius: .875rem; background: var(--cbm-bg); border: 1px solid var(--cbm-card-border); color: var(--cbm-text);" wire:model.live.debounce.300ms="search">
            </div>
            <button wire:click="create()" class="cbm-btn cbm-btn-primary" style="background: linear-gradient(135deg, #22c55e, #10b981); box-shadow: 0 4px 12px rgba(34,197,94,0.3); border: none; color: white; padding: 0 1.5rem; height: 2.75rem; border-radius: .875rem; font-weight: 700; display: flex; align-items: center; gap: .5rem; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;">
                            ...
                            <td colspan="5">
                                <div class="cbm-empty-state">
                                    ...
                                    <div>
                                        ...
                                        <p>Tidak ada data general cleaning yang ditemukan.</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; z-index: 50; padding: 1rem; backdrop-filter: blur(4px);">
        <div style="background: var(--cbm-card-bg); border: 1px solid var(--cbm-card-border); border-radius: 1.25rem; width: 100%; max-width: 32rem; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04); overflow: hidden;">
            <div style="padding: 1.5rem; border-bottom: 1px solid var(--cbm-card-border); display: flex; justify-content: space-between; align-items: center; background: var(--cbm-nav-hover);">
                <h3 style="font-size: 1.25rem; font-weight: 800; color: var(--cbm-text); margin: 0;">{{ $cleaningId ? 'Edit' : 'Tambah' }} General Cleaning</h3>
            ...
            <form wire:submit.prevent="save" style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1.25rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <textarea wire:model="remarks" class="cbm-input" rows="3" placeholder="Catatan tambahan (Opsional)" style="padding: 0.75rem; border-radius: 0.75rem; border: 1px solid var(--cbm-input-border); background: var(--cbm-bg); color: var(--cbm-text); resize: vertical;"></textarea>
                    @error('remarks') <span style="color: #ef4444; font-size: 0.75rem;">{{ $message }}</span> @enderror
                </div>
                
                <div style="display: flex; justify-content: flex-end; gap: 0.75rem; margin-top: 0.5rem;">
                    <button type="button" wire:click="closeModal()" class="cbm-btn" style="padding: 0.75rem 1.5rem; border-radius: 0.75rem; font-weight: 600; background: transparent; border: 1px solid var(--cbm-input-border); color: var(--cbm-text); cursor: pointer; transition: background 0.2s;">Batal</button>
