<div>
    ...
    <div class="mod-header">
        <div class="mod-title-block">
            <div class="mod-title-accent mod-title-accent-purple">Non-Safety Referred Deferral Item</div>
            <div class="mod-title">NSRDI</div>
            <div class="mod-subtitle">Item penundaan terkait non-keselamatan pesawat.</div>
        </div>
                        ...
                        <tr>
                            <td colspan="22">
                                <div class="mod-empty">
                                    ...
                                    <div class="mod-empty-sub">Klik "Import NSRDI" untuk mengunggah data.</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    >
        <div class="cbm-modal-panel" @click.stop>
            <div class="cbm-modal-header">
                <div>
                    <div class="cbm-modal-title">Import Data NSRDI</div>
                    <div class="cbm-modal-subtitle">Unggah file Excel untuk memuat data NSRDI</div>
                </div>
            ...
            <form wire:submit="importNsrdi">
                ...
                <div class="cbm-modal-footer">
                    ...
                    <button type="submit" class="mod-btn-primary" wire:loading.attr="disabled">
                        <span wire:loading.remove wire:target="importNsrdi">
                            <span style="display:inline-flex;align-items:center;gap:.4rem;">
                        ...
                        <span wire:loading wire:target="importNsrdi">
                            <span style="display:inline-flex;align-items:center;gap:.4rem;">
