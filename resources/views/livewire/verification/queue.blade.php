<div>
    ...
    <div class="cbm-card" style="text-align: center; padding: 4rem 2rem;">
        ...
        <p style="color: var(--cbm-text-sub); font-size: 0.875rem; max-width: 400px; margin: 0 auto;">Antarmuka dan fungsionalitas untuk modul <strong>Verification Queue</strong> sedang dalam tahap pengembangan sesuai dengan desain sistem role-based.</p>
    </div>
</div>
